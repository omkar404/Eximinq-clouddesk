...
import {
  deleteDocument, downloadDocument, getConfiguration, getLedger, getQuote,
  getRequests, saveDraft, submitRequest, uploadDocument
} from "../controllers/industrialLicense.controller.js";
...
export function createIndustrialLicenseRouter({ requireAuth }) {
  const router = Router();
