    ...
    <div className="dashboard-page dashboard-console">
      ...
      <section className="dashboard-hero relative overflow-hidden p-6 md:p-8">
        ...
        <div className="relative flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-3 py-1.5 text-[10px] font-black uppercase tracking-[.14em] text-blue-700">
              <Sparkles size={13} /> Live trade workspace
            </div>
            <h1 className="premium-page-title">Your operations, beautifully in control.</h1>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500">
              Track every filing, document, payment, and compliance milestone from one intelligent command center.
            </p>
          </div>
          <div className="flex flex-wrap gap-2">
            <button className="premium-button premium-button-secondary"><ReceiptText size={15} /> Match receipts</button>
            <button className="premium-button premium-button-primary"><Plus size={16} /> New request</button>
          </div>
        </div>
      </section>
      ...
      <section className="dashboard-table-card">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 px-3 py-2.5">
          <div>
            ...
            <h2 className="mt-1 text-base font-bold text-slate-950">Request ledger</h2>
